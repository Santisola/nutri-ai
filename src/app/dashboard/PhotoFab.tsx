    ...
    <div className="relative flex flex-1 justify-center">
      {open && (
        <>
          ...
          />
          <div className="absolute bottom-22 left-1/2 z-40 flex -translate-x-1/2 flex-col gap-2 rounded-2xl border border-zinc-200 bg-white p-2 shadow-lg dark:border-zinc-700 dark:bg-zinc-800">
